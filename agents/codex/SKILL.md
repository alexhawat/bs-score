...
```bash
git clone --depth 1 https://github.com/alexhawat/bs_score ~/.codex/skills/bs_score   # personal
git clone --depth 1 https://github.com/alexhawat/bs_score .agents/skills/bs_score   # project
```

`~/.codex/skills/bs_score` applies to every project; `.agents/skills/bs_score` is checked into one
repository. Keep the folder name `bs_score` — it is the skill's name. Codex also reads `~/.agents/skills/`.
