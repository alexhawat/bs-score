...
```bash
git clone --depth 1 https://github.com/alexhawat/bs_score ~/.codex/skills/bs-score   # personal
git clone --depth 1 https://github.com/alexhawat/bs_score .agents/skills/bs-score   # project
```
