...
```bash
git clone --depth 1 https://github.com/alexhawat/bs_score ~/.claude/skills/bs_score   # personal
git clone --depth 1 https://github.com/alexhawat/bs_score .claude/skills/bs_score   # project
```

`~/.claude/skills/bs_score` applies to every project; `.claude/skills/bs_score` is checked into one
repository. Keep the folder name `bs_score` — it is the skill's name.
