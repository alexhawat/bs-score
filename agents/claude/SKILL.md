...
```bash
git clone --depth 1 https://github.com/alexhawat/bs-score ~/.claude/skills/bs-score   # personal
git clone --depth 1 https://github.com/alexhawat/bs-score .claude/skills/bs-score   # project
```
