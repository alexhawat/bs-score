...
**The skill** — clone the repository into Grok Build's skills folder, so the root
`SKILL.md` and the `checklists/` it links to land together:

```bash
git clone --depth 1 https://github.com/alexhawat/bs-score ~/.grok/skills/bs-score   # personal
git clone --depth 1 https://github.com/alexhawat/bs-score .grok/skills/bs-score   # project
```
