...
**The skill** — clone the repository into OpenClaw's skills folder, so the root
`SKILL.md` and the `checklists/` it links to land together:

```bash
git clone --depth 1 https://github.com/alexhawat/bs-score ~/.openclaw/skills/bs-score   # personal
git clone --depth 1 https://github.com/alexhawat/bs-score <workspace>/skills/bs-score   # project
```
