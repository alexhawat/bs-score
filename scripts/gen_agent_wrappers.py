...
```bash
git clone --depth 1 https://github.com/alexhawat/bs_score {personal}   # personal
git clone --depth 1 https://github.com/alexhawat/bs_score {project}   # project
```
...
```bash
git clone --depth 1 https://github.com/alexhawat/bs_score {personal}
